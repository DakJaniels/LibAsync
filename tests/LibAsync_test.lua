...
Taneth("LibAsync", function ()
    ...
    describe("Loop Tasks", function ()
        ...
        it.async("should handle pairs iteration", function (done)
            ...
            task:For(pairs(testTable)):Do(function (key, value)
                result[key] = value
            end):Finally(function ()
        ...
        it.async("should handle ipairs iteration", function (done)
            ...
            task:For(ipairs(testArray)):Do(function (index, value)
                result[index] = value
            end):Finally(function ()
    ...
    describe("Error Handling", function ()
        ...
        it.async("should execute Finally block on error", function (done)
            ...
            task:Call(function ()
                errorOccurred = true
                error("Test error")
            end):OnError(function () end) -- Suppress error logging
                :Finally(function ()
                    finallyExecuted = true
    ...
    describe("Sorting", function ()
        ...
        it.async("should sort array with custom comparison", function (done)
            ...
            task:Sort(array, function (a, b) return a > b end):Finally(function () -- Descending
